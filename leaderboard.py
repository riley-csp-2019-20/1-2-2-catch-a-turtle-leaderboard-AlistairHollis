...
def draw_leaderboard(leader_names, leader_scores, high_scorer, turtle_object, player_score):
  ...
  if (high_scorer):
    ...
    turtle_object.write("Only boomers don't make it on the leaderboard >:D.", font=font_setup)
  ...
  if (player_score >= gold_score):
    ...
    font_setup = ("impact", 10, "normal")
    turtle_object.write("Congratulations, by failing to get 15 points, you have proven your lack of basic motor skills.", font=font_setup)